...
import com.conacti.controlacapi.converters.AsignaturaConverter;
import com.conacti.controlacapi.dtos.AsignaturaDTO;
import com.conacti.controlacapi.entities.Asignatura;
import com.conacti.controlacapi.services.AsignaturaService;
...
public class AsignaturaController {
	 ...
	 * Retorna: Datos de la asignatura
	 */	
	@PutMapping(value = "/asignaturas/{asignaturaId}")
	public ResponseEntity<WrapperResponse<AsignaturaDTO>> disable(@PathVariable("asignaturaId") Long asignaturaId) {
		...
		AsignaturaDTO asignaturaDTO = converter.fromEntity(asignatura);
		return new WrapperResponse<>(true, "La asignatura se ha eliminado correctamente", asignaturaDTO).createResponse(HttpStatus.OK);
	}
