...
import com.conacti.controlacapi.converters.UsuarioConverter;
import com.conacti.controlacapi.dtos.LoginRequestDTO;
import com.conacti.controlacapi.dtos.LoginResponseDTO;
import com.conacti.controlacapi.dtos.UsuarioDTO;
import com.conacti.controlacapi.entities.Usuario;
import com.conacti.controlacapi.services.UsuarioService;
...
public class UsuarioController {
	...
	public ResponseEntity<WrapperResponse<List<UsuarioDTO>>> findByPerfil(@PathVariable("perfilId") Long perfilId) {
		List<Usuario> listaUsuarios = usuarioService.findByPerfil(perfilId);
	...
	public ResponseEntity<WrapperResponse<UsuarioDTO>> disable(@PathVariable("usuarioId") Long usuarioId) {
		...
		UsuarioDTO usuarioDTO = converter.fromEntity(usuario);
		return new WrapperResponse<>(true, "El usuario se ha eliminado correctamente", usuarioDTO).createResponse(HttpStatus.OK);
	}
}