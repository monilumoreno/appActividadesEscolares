...
INSERT INTO perfiles (descripcionperfil) VALUES ('Administrador');
INSERT INTO perfiles (descripcionperfil) VALUES ('Docente');
INSERT INTO perfiles (descripcionperfil) VALUES ('Acudiente');

INSERT INTO usuarios (idperfil, tipodocumento, numerodocumento, nombres, apellidos, telefono, direccion, correo, usuario, clave)
VALUES (1, 1, '1010001001', 'Administrador 1', 'Adiminstrador 1', '3100010000', 'Calle 100 20-42', 'admin1@correo.com', 'admin1', '123');
INSERT INTO usuarios (idperfil, tipodocumento, numerodocumento, nombres, apellidos, telefono, direccion, correo, usuario, clave)
VALUES (2, 1, '1020100100', 'Docente 1', 'Docente 1', '3101001010', 'Carrera 56 70-88', 'docente1@correo.com', 'docente1', '456');
INSERT INTO usuarios (idperfil, tipodocumento, numerodocumento, nombres, apellidos, telefono, direccion, correo, usuario, clave)
VALUES (2, 1, '1030300300', 'Docente 2', 'Docente 2', '3102002020', 'Avenida 6 4-8', 'docente2@correo.com', 'docente2', '789');
INSERT INTO usuarios (idperfil, tipodocumento, numerodocumento, nombres, apellidos, telefono, direccion, correo, usuario, clave)
VALUES (2, 1, '1040400400', 'Docente 3', 'Docente 3', '3104004040', 'Carrera 93 6-83', 'docente3@correo.com', 'docente3', '012');
INSERT INTO usuarios (idperfil, tipodocumento, numerodocumento, nombres, apellidos, telefono, direccion, correo, usuario, clave)
VALUES (3, 1, '1050500500', 'Acudiente 1', 'Acudiente 1', '3105005050', 'Avenida 30 90-31', 'acudiente1@correo.com', 'acudiente1', '123');
INSERT INTO usuarios (idperfil, tipodocumento, numerodocumento, nombres, apellidos, telefono, direccion, correo, usuario, clave)
VALUES (3, 1, '1060600600', 'Acudiente 2', 'Acudiente 2', '3106006060', 'Carrera 73 38-31', 'acudiente2@correo.com', 'acudiente2', '456');
INSERT INTO usuarios (idperfil, tipodocumento, numerodocumento, nombres, apellidos, telefono, direccion, correo, usuario, clave)
