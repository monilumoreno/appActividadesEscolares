...
const TareasEditar = () => {
    ...
    const { descripcionTarea, fechaCreacion, fechaEntrega, asignatura, curso } = tarea;
                                                ...
                                                <form onSubmit={onSubmit} className="needs-validation" novalidate>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-12 mb-2 mb-md-0">
                                                            <button type="submit" className="btn btn-success me-1" tabIndex="5" id="crear">Guardar</button>
