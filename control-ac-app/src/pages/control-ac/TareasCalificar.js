...
const TareasCalificar = () => {
    ...
    const { numeroDocumento, nombres, apellidos, curso, asignatura, tarea, observaciones, calificacion, idTarea } = relTareasAlumno;
                                                ...
                                                <form onSubmit={onSubmit} className="needs-validation" novalidate>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 mb-2">
                                                            ...
                                                            <Link to="/tareas" class="btn btn-danger" id="cerrar">Cerrar</Link>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
