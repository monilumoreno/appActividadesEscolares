...
const AlumnosEditar = () => {
    ...
    const findById = async () => {
        try {
            ...
            console.log(error);            
            ErrorAlert.showAlert("Error al cargar los datos del alumno");
        } 
    }
    ...
    const editarAlumno = async () => {
        ...
        try {
            ...
            console.log(error);            
            ErrorAlert.showAlert("Error al editar los datos del alumno");
        }          
    }    
                                                ...
                                                <form onSubmit={onSubmit} className="needs-validation" novalidate>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-6 mb-2 mb-md-0">
                                                            ...
                                                            <Link to="/alumnos" className="btn btn-success me-1" id="cerrar" tabindex="11">Cerrar</Link>
                                                        </div>
                                                    </div>
                                                </form>                                                
                                            </div>
