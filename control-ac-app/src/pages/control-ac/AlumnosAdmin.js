                                    ...
                                    <tbody>
                                        {
                                            resultados.map(
                                                ...
                                                <tr key={item.idAlumno}>
                                                    ...
                                                    <td nowrap="">
                                                        <Link to={`/alumnos-editar/${item.idAlumno}`} className="btn btn-sm btn-primary w-70px me-1">Editar</Link>
                                                        <button onClick={(e) => confirmarEliminacion(e, item.idAlumno)} className="btn btn-sm btn-danger w-70px">Eliminar</button>
                                                    </td>
                                                </tr>
