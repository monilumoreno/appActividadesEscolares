		...
		try {
			...
			if (response.ok) {
                ...
                if (nombres.indexOf(' ') !== -1) {
                    nombreCompleto = nombres.substring(0, nombres.indexOf(' '));
                } else {
                    nombreCompleto = nombres;
                }

                if (apellidos.indexOf(' ') !== -1) {
                    nombreCompleto = `${nombreCompleto} ${apellidos.substring(0, apellidos.indexOf(' '))}`;
                } else {
                    nombreCompleto = `${nombreCompleto} ${apellidos}`;
                }
