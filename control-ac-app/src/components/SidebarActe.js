...
const SidebarActe = () => {
	...
	const perfil = localStorage.nomPerfil;
                ...
                <div className="app-sidebar-content" data-scrollbar="true" data-height="100%">
                    <div className="menu">
                        ...
                        <div className="menu-item active">
                            <Link to="/homeacudiente" className="menu-link">
                        ...
                        <div className="menu-item has-sub">
                            ...
                            <div className="menu-submenu">
                                <div className="menu-item"><Link to="" className="menu-link"><div className="menu-text">Revisar Actividades</div></Link></div>                                
                            </div>
                        </div>
